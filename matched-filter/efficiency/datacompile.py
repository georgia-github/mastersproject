...
np.save("complied2maximum_noise_snrsignals.pkl", maximum_noise_snrsignals, allow_pickle=True)
np.save("complied2injected_signal_freq.pkl", injected_signal_freq, allow_pickle=True)
np.save("complied2injected_signal_tau.pkl", injected_signal_tau, allow_pickle=True)
np.save("complied2injected_signal_amp.pkl", injected_signal_amp, allow_pickle=True)
np.save("complied2injected_signal_optimal_snr.pkl", injected_signal_optimal_snr, allow_pickle=True)
np.save("complied2injected_signal_RA.pkl", injected_signal_RA, allow_pickle=True)
np.save("complied2injected_signal_DEC.pkl", injected_signal_DEC, allow_pickle=True)
np.save("complied2injected_signal_inclination.pkl", injected_signal_inclination, allow_pickle=True)
