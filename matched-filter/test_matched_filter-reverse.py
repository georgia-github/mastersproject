...
datareversed = list(reversed(injH1.data.to_frequencyseries()))
datareversed2 = np.flip(injH1.data.to_frequencyseries())
stilde = injH1.data[::-1].to_frequencyseries()
'''
...
#print('Stilde is:',stilde[-1])
#print('Reversed Stilde is:',datareversed2[0])
...
plt.xlabel('time (s)')
plt.show()
plt.savefig('reversedoriginalmatchedfilter.png')